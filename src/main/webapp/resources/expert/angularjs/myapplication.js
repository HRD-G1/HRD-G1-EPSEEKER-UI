...
app.controller('EduAndExpController', function ($scope) {
    $scope.edu = [
        {id: 1, university: "RUPP University", sYear: "2010-02-02", eYear: "2014-02-02", major: "MIS", des: "Add Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des Here"},
        {id: 2, university: "SETEC Intitute", sYear: "2010-02-02", eYear: "2014-02-02", major: "Computer Science", des: "Add Des Here Add Des Here Add Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des HereAdd Des Here "},
        {id: 3, university: "NORTON University", sYear: "2010-02-02", eYear: "2014-02-02", major: "Software Engineer", des: "Add Des Here"}
        ];

    $scope.curJob = [
       {id: 1, institution: "World Bank", contactPhone: "023 400 949", email: "worldBank@gmail.com", address: "Boeung Kak II, Toul Kork, Phnom Penh",  position: "DBA",  salary: 850},
       {id: 2, institution: "Blue Technology", contactPhone: "023 450 343", email: "blueTech@gmail.com", address: "Boeung Kak II, Toul Kork, Phnom Penh",  position: "Spring Developer",  salary: 950}
       ];

    $scope.exp = [
        {id: 1, institution: "ANZ Bank", contactPhone: "023 400 949", email: "worldBank@gmail.com", startDate: "2013-02-30", endDate: "2014-02-30",  position: "DBA"},
        {id: 2, institution: "BIZ Technology", contactPhone: "023 450 343", email: "bizTech@gmail.com", startDate: "2014-02-30", endDate: "2015-02-30", position: "Spring Developer"},
        {id: 2, institution: "PNN TV Station", contactPhone: "023 450 343", email: "PNNTV@gmail.com", startDate: "2015-02-30", endDate: "2016-02-30", position: "Spring Developer"}
        ];
...
app.controller('SkillController', function ($scope) {
   ...
   /* $scope.mainSkills = [
    ...
    $scope.expertSkill = [
        {id: 1, exSkill: "JAVA", mention: "High", level: 75, mainSkill: "Programming"},
        {id: 2, exSkill: "SQLServer", mention: "High", level: 75, mainSkill: "Database"},
        {id: 3, exSkill: "ORACLE", mention: "Midium", level: 50, mainSkill: "Database" },
        {id: 4, exSkill: "ASP.Net", mention: "Low", level: 25, mainSkill: "Programming"}
    ];
...
//		Speaking
		if(EL.el.ELSpeaking == "Fair"){
			$scope.sFair = true; $scope.sAverage = false; $scope.sGood = false; $scope.sPerfect = false;
		}else if(EL.el.ELSpeaking == "Average"){
			$scope.sFair = false; $scope.sAverage = true; $scope.sGood = false; $scope.sPerfect = false;
		}else if(EL.el.ELSpeaking == "Good"){
			$scope.sFair = false; $scope.sAverage = false; $scope.sGood = true; $scope.sPerfect = false;
		}else{
			$scope.sFair = false; $scope.sAverage = false; $scope.sGood = false; $scope.sPerfect = true;
		}
		
//		Listening
		if(EL.el.ELListening == "Fair"){
			$scope.lFair = true; $scope.lAverage = false; $scope.lGood = false; $scope.lPerfect = false;
		}else if(EL.el.ELListening == "Average"){
			$scope.lFair = false; $scope.lAverage = true; $scope.lGood = false; $scope.lPerfect = false;
		}else if(EL.el.ELListening == "Good"){
			$scope.lFair = false; $scope.lAverage = false; $scope.lGood = true; $scope.lPerfect = false;
		}else{
			$scope.lFair = false; $scope.lAverage = false; $scope.lGood = false; $scope.lPerfect = true;
		}
		
//		Writing
		if(EL.el.ELWriting == "Fair"){
			$scope.wFair = true; $scope.wAverage = false; $scope.wGood = false; $scope.wPerfect = false;
		}else if(EL.el.ELWriting == "Average"){
			$scope.wFair = false; $scope.wAverage = true; $scope.wGood = false; $scope.wPerfect = false;
		}else if(EL.el.ELWriting == "Good"){
			$scope.wFair = false; $scope.wAverage = false; $scope.wGood = true; $scope.wPerfect = false;
		}else{
			$scope.wFair = false; $scope.wAverage = false; $scope.wGood = false; $scope.wPerfect = true;
		}
		
//		Reading
		if(EL.el.ELReading == "Fair"){
			$scope.rFair = true; $scope.rAverage = false; $scope.rGood = false; $scope.rPerfect = false;
		}else if(EL.el.ELReading == "Average"){
			$scope.rFair = false; $scope.rAverage = true; $scope.rGood = false; $scope.rPerfect = false;
		}else if(EL.el.ELReading == "Good"){
			$scope.rFair = false; $scope.rAverage = false; $scope.rGood = true; $scope.rPerfect = false;
		}else{
			$scope.rFair = false; $scope.rAverage = false; $scope.rGood = false; $scope.rPerfect = true;
		}
	}*/
...
app.controller('jobExpectaion', function ($scope, $http) {
	$scope.jobExpectation = [
	                         {id: 1, postion: "Adroid Developer", minSalary: 500, maxSalary: 800, location: "Phnom Penh"},
	                         {id: 2, postion: "Spring Developer", minSalary: 800, maxSalary: 1500, location: "Phnom Penh"}
	                         ];
});
