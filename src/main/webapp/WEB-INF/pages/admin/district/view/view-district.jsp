    ...
    <table class="table table-striped table-bordered table-list">
                  ...
                  <tbody>
                          <tr ng-repeat="dis in districtObject">
                            ...
                            <td align="center">
                              <a class="btn btn-default" ng-click="getUpdateDitrict(this)" data-toggle="modal" data-target="#addDistrict" ><em class="fa fa-pencil"></em></a>
                              <a class="btn btn-danger" ng-click="removeDistrict(dis.DISTRICT_ID)"><em class="fa fa-trash"></em></a>
                            </td>
                          </tr>
                        </tbody>
                </table>
